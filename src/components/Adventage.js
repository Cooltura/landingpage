...
export default class Adventage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      array: [],
      text_array: [
        texts.adventage.texts[0],
        texts.adventage.texts[1],
        texts.adventage.texts[2],
        texts.adventage.texts[3],
        texts.adventage.texts[4],
        texts.adventage.texts[5],
        texts.adventage.texts[6],
        texts.adventage.texts[7],
        texts.adventage.texts[8],
      ],
      img_array: [
        imgadventage1,
        imgadventage2,
  ...
  render() {
    return (
      <MainDiv
        ...
        padding="0.5em 4.4em 1em 4.4em"
      >
        <H2>{texts.adventage.header}</H2>
        <Container>
          <Item id="MyDiv0">
            <div>
              <Img src={this.state.img_array[0]} width="5" alt="image0"></Img>
            </div>
            <div>{this.state.text_array[0]}</div>
          </Item>
          <Item id="MyDiv1">
            <div>
              <Img src={this.state.img_array[1]} width="5" alt="image1"></Img>
            </div>
            <div>{this.state.text_array[1]}</div>
          </Item>
          <Item id="MyDiv2">
            <div>
              <Img src={this.state.img_array[2]} width="5" alt="image2"></Img>
            </div>
            <div>{this.state.text_array[2]}</div>
          </Item>
          <Item id="MyDiv3">
            <div>
              <Img src={this.state.img_array[3]} width="5" alt="image3"></Img>
            </div>
            <div>{this.state.text_array[3]}</div>
          </Item>
          <Item id="MyDiv4">
            <div>
              <Img src={this.state.img_array[4]} width="5" alt="image4"></Img>
            </div>
            <div>{this.state.text_array[4]}</div>
          </Item>
          <Item id="MyDiv5">
            <div>
              <Img src={this.state.img_array[5]} width="5" alt="image4"></Img>
            </div>
            <div>{this.state.text_array[5]}</div>
          </Item>
          <Item id="MyDiv6">
            <div>
              <Img src={this.state.img_array[6]} width="5" alt="image4"></Img>
            </div>
            <div>{this.state.text_array[6]}</div>
          </Item>
          <Item id="MyDiv7">
            <div>
              <Img src={this.state.img_array[7]} width="5" alt="image4"></Img>
            </div>
            <div>{this.state.text_array[7]}</div>
          </Item>
          <Item id="MyDiv8">
            <div>
              <Img src={this.state.img_array[8]} width="5" alt="image4"></Img>
            </div>
            <div>{this.state.text_array[8]}</div>
          </Item>
